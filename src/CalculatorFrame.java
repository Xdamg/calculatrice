...
//        add our component to frame
        ...
        JrnButtons[0] = new JButton("To Base 2");
        JrnButtons[1] = new JButton("To Base 8");
        JrnButtons[2] = new JButton("To Base 10");
        JrnButtons[3] = new JButton("To Base 16");
        ...
        JbnButtons[22] = new JButton("CLEAR");
        ...
        for (int i = 0; i < JbnButtons.length; i++) {
            ...
            if (i < 10){
                ...
                JbnButtons[i].setFont(new Font("Tahoma", Font.BOLD, 20));
                JbnButtons[i].setBounds(78, 85, 50, 50);
            }
            else
...
//        jMaster.add(jHexButton, BorderLayout.SOUTH);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(str == "To Base 2")  {PREVIOUS = CURRENT ; CURRENT = "2";jBase.setText("Base 2");}
        if(str == "To Base 8")  {PREVIOUS = CURRENT ; CURRENT = "8";jBase.setText("Base 8");}
        if(str == "To Base 10") {PREVIOUS = CURRENT ; CURRENT = "10";jBase.setText("Base 10");}
        if(str == "To Base 16") {PREVIOUS = CURRENT ; CURRENT = "16";jBase.setText("Base 16");}
        ...
        switch(str)
        {
            ...
            case "To Base 2"  :
                if (CURRENT == PREVIOUS) {}else {
                    if (CURRENT == "10") {
                        numStr1=String.valueOf(toDeci(String.valueOf(numStr1), Integer.valueOf(PREVIOUS)));
                        jLabelOuput.setText(numStr1);
                        firstInput = true;
                        break;}
                    if (PREVIOUS == "10") {
                        numStr1=String.valueOf(fromDeci(Integer.valueOf(CURRENT),(Integer.valueOf(numStr1))));
                        jLabelOuput.setText(numStr1);
                        firstInput = true;
                        break;
                    }else {
